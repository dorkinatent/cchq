...
export function MessageBubble({
  ...
  return (
    <div className="mb-5">
      ...
      {hasContent && (
        <div
          className={`group relative rounded-lg px-4 py-3 text-sm leading-relaxed max-w-[min(96%,720px)] overflow-hidden break-words ${
            isUser
